            ...
            #Examining the length of eyes object for eyes
                ...
                #Check if program is running for detection 
                    ...
                    #This will print on console and restart the algorithm
                        count+=1
                        print("Blink detected-------------- count", count)
                        cv2.waitKey(3000)
                        first_read=True
...
while(n<=3):
    read.append(BlinkDetect())
    print('reading taken')
    time.sleep(10)
    n+=1


print('readings taken are : ')
for i in range(len(read)):
    print(read[i])



if(read[0]==read[1] and read[2]==read[1]):
    print('Reading is fake')
else:
    print('Reading is genuine')
